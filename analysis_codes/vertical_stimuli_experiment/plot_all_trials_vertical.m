...
% This file plots
% a participant's gaze positions during three fixation conditions:
...
for subj = 1 % plots the participant shown in Figure 3 of Hu et al.
    ...
    trialRoutine = strcmp(easyeyes.trialStep,'trialRoutineEachFrame');
