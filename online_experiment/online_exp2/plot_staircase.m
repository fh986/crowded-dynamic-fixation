...
for subj = 1:numSubj
    ...
    ntrials = 35;
    cond_seq = {'Stationary Right','Stationary Left', ...
        'Dynamic Right','Dynamic Left','Flies Right','Flies Left'};
    ...
    for b = 7:9 % blocks 
        ...
        for s = 1:2 % 1 = right threshold, 2 = left threshold
            ...
            h(ct) = plot(10.^t_block_cond.questMeanBeforeThisTrialResponse,'Color',cell2mat(lineColors(rem(b,3)+1)),'LineWidth',2);
            ct = ct + 1;
